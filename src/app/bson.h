 ...
 */
 size_t bson_buffer_size( const bson *b );
 ...
 */
 ...
 bson_iterator* bson_iterator_alloc( void );
 void bson_iterator_dealloc(bson_iterator*);
/**
 ...
 */
 void bson_iterator_code_scope_init( const bson_iterator *i, bson *scope, bson_bool_t copyData );
 ...
 */
 void bson_iterator_subobject_init( const bson_iterator *i, bson *sub, bson_bool_t copyData );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
 int bson_append_symbol_n( bson *b, const char *name, const char *str, size_t len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
 int bson_append_code_n( bson *b, const char *name, const char *str, size_t len );
