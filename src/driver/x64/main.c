...
NTSTATUS DriverEntry(PDRIVER_OBJECT pDriverObject, PUNICODE_STRING pRegistryPath)
{
	...
	RtlInitUnicodeString(&function, L"ZwQueryVirtualMemory");
	ZwQueryVirtualMemory = MmGetSystemRoutineAddress(&function);
	...
	#ifdef DEBUG
	KdPrintEx(( DPFLTR_IHVDRIVER_ID,DPFLTR_ERROR_LEVEL, "IOCTL_CUCKOO_PATH : 0x%08x\n", IOCTL_CUCKOO_PATH));
	#endif
