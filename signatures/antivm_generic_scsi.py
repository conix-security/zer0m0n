...
class AntiVMSCSI(Signature):
    ...
    def on_call(self, call, process):
        ...
        if call["api"] == "REGISTRY_QUERY_VALUE_KEY":
            if string.find(self.get_argument(call,"SubKey").lower(),indicator_key.lower()) != -1 and self.get_argument(call,"ValueName").lower() == indicator_name.lower():
                return True
